...
<fieldset>
	...
	<a style="float:right; margin:0 10px;" href="#" class="dodelete-location button">Remove All Locations</a>
	...
	<?php $mb->the_group_open(); ?>
		...
		<?php $metabox->the_field('phonetype'); ?>
		<select name="<?php $metabox->the_name(); ?>">
		<option value=""></option>
		<option value="main"<?php if ($metabox->get_the_value() == 'main') echo $selected; ?>>Main</option>
		<option value="office"<?php if ($metabox->get_the_value() == 'office') echo $selected; ?>>Office</option>
		<option value="cell"<?php if ($metabox->get_the_value() == 'cell') echo $selected; ?>>Cell</option>
		</select>
		...
		<a href="#" class="dodelete button">Remove This Location</a>
 

	<?php $mb->the_group_close(); ?>
	<?php endwhile; ?>
 	<p>If this business has multiple locations, but you want them all to appear in one business listing, add the other locations here.  If you want the other locations to have their own individual listing on the site, create a new business with this business as the parent.</p>
	<p style="margin-bottom:15px; padding-top:5px;"><a href="#" class="docopy-location button">Add Another Location</a></p>
</fieldset>

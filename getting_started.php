    ...
    <div class="wrap">
      ...
      <div id="top" class="cdash_getting_started_docs cdash_admin_page">
        ...
        <div id="step_3" class="cdash_wrapper one_col cdash_admin_grid">
          <div class="cdash_admin_left_col">
            ...
            <p>Create ‘Claim My Business’ and ‘Edit My Business’ pages. <a href="https://chamberdashboard.com/document/install-setup-member-updater/member-updater-setup/" target="_blank">Full setup instructions here.</a><i> (Note: You will need to be logged in to your ‘My Account’ page on ChamberDashboard.com to access these documents.)</i></p>
        </div><!--cdash_admin_left_col-->
        <p class="right"><a href="#top">Top</a></p>
      </div><!--cdash_wrapper-->
      ...
      <div id="step_4" class="cdash_wrapper one_col cdash_admin_grid">
        <div class="cdash_admin_left_col">
          ...
          <p><a href="https://chamberdashboard.com/document/crm-docs/" target="_blank">Download and install</a> the CRM plugin.</a><p>
        ...
        <div id="step_5" class="cdash_wrapper one_col cdash_admin_grid" style="padding-bottom:0; margin-bottom:0px;">
          <div class="cdash_admin_left_col">
            ...
            <p><a href="https://chamberdashboard.com/document/install-member-manager/" target="
              ">Download and install</a> the Member Manager plugin. <a href="https://chamberdashboard.com/document/member-manager-docs/" target="_blank">Connect to Paypal</a> (Chamber Dashboard >> Member Manager Options).</p>
        ...
        <div class="cdash_wrapper cdash_admin_grid" style="padding-top:0;">
          <div class="cdash_admin_left_col">
            ...
            <p><a href="https://chamberdashboard.com/document/install-recurring-payments/automated-invoicing-wordpress-plugin/" target="_blank">Set notification timeframes</a> & reminder frequencies.</p>
          </div><!--cdash_admin_left_col-->
          <div class="cdash_admin_right_col">
        ...
        <div id="step_6" class="cdash_wrapper one_col cdash_admin_grid">
          <div class="cdash_admin_left_col">
            ...
            <a href="http://chamber-beautiful.chamberdashboard.com/event-calendar/" target="_blank">See Events Calendar in Action</a>
            <p class="right"><a href="#top">Top</a></p>
          </div><!--cdash_admin_left_col-->
        </div><!--cdash_wrapper-->

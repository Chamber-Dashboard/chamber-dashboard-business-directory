...
function cdash_add_options_page() {
    ...
    add_submenu_page( '/cd-settings', 'CD Business Directory', 'CD Business Directory', 'manage_options', 'cd-settings&tab=directory', 'cdash_directory_settings' );
    //add_submenu_page( '/cd-settings', 'CD Addons', 'CD Addons', 'manage_options', 'chamber-dashboard-business-directory/options.php', 'cdash_about_screen' );
...
add_action('admin_init', 'setup_cd_sections');
function setup_cd_sections() {
    add_settings_section( 'our_first_section', 'My First Section Title', false, 'cd-settings' );
}


function cdash_other_plugin_options(){
    // Add the menu item and page
    $page_title = 'Chamber Dashboard Addons';
    $menu_title = 'Chamber Dashboard Addons';
    $capability = 'manage_options';
    $slug = '/chamber-dashboard-business-directory/options.php';
    //$slug = '/chamber-dashboard-business-directory/options.php';
    //$callback = array( $this, 'plugin_settings_page_content' );
    $callback = 'cdash_render_form';
    $icon = 'dashicons-admin-plugins';
    $position = 90;
    add_menu_page( $page_title, $menu_title, $capability, $slug, $callback, $icon, $position );
}
...
add_action( 'cdash_settings_tab', 'cdash_directory_tab', 2 );
...
add_action( 'cdash_settings_tab', 'cdash_export_tab', 3 );
function cdash_export_tab(){
	global $cdash_active_tab; ?>
    <a class="nav-tab <?php echo $cdash_active_tab == 'export' ? 'nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page=cd-settings&tab=export' ); ?>"><?php _e( 'Export', 'cdash' ); ?> </a>
	<?php
}

add_action( 'cdash_settings_tab', 'cdash_import_tab', 4 );
function cdash_import_tab(){
	global $cdash_active_tab; ?>
    <a class="nav-tab <?php echo $cdash_active_tab == 'import' ? 'nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page=cd-settings&tab=import' ); ?>"><?php _e( 'Import', 'cdash' ); ?> </a>
	<?php
}
...
//Welcome Tab
//add_action( 'cdash_settings_tab', 'cdash_welcome_tab', 1 );
function cdash_welcome_tab(){
	global $cdash_active_tab; ?>
	<a class="nav-tab <?php echo $cdash_active_tab == 'welcome' || '' ? 'nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page=cd-settings&tab=welcome' ); ?>"><?php _e( 'Welcome', 'cdash' ); ?> </a>
	<?php
}


//add_action( 'cdash_settings_tab', 'cdash_mm_tab',  5);
function cdash_mm_tab(){
	global $cdash_active_tab; ?>
    <a class="nav-tab <?php echo $cdash_active_tab == 'member-manager' ? 'nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page=cd-settings&tab=member-manager' ); ?>"><?php _e( 'Member Manager', 'cdash' ); ?> </a>
	<?php
}

//add_action( 'cdash_settings_tab', 'cdash_crm_tab',  6);
function cdash_crm_tab(){
	global $cdash_active_tab; ?>
    <a class="nav-tab <?php echo $cdash_active_tab == 'crm' ? 'nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page=cd-settings&tab=crm' ); ?>"><?php _e( 'CRM Options', 'cdash' ); ?> </a>
	<?php
}

//add_action( 'cdash_settings_tab', 'cdash_calendar_tab',  7);
function cdash_calendar_tab(){
	global $cdash_active_tab; ?>
    <a class="nav-tab <?php echo $cdash_active_tab == 'calendar' ? 'nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page=cd-settings&tab=calendar' ); ?>"><?php _e( 'Calendar', 'cdash' ); ?> </a>
	<?php
}

//add_action( 'cdash_settings_tab', 'cdash_mu_tab',  8);
function cdash_mu_tab(){
	global $cdash_active_tab; ?>
    <a class="nav-tab <?php echo $cdash_active_tab == 'member-updater' ? 'nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page=cd-settings&tab=member-updater' ); ?>"><?php _e( 'Member Updater', 'cdash' ); ?> </a>
	<?php
}
